...
sat_refrigerantDict = {'r23':df_sat_r23, 'r32':df_sat_r32, 'r134a':df_sat_r134a, 'r236fa':df_sat_r236fa, 'r245fa':df_sat_r245fa, 'r290':df_sat_r290, 'r404a':df_sat_r404a, 'r407a':df_sat_r407a, 'r410a':df_sat_r410a, 'r438a':df_sat_r438a, 'r449a':df_sat_r449a, 'r452a':df_sat_r452a, 'r455a':df_sat_r455a, 'r507a':df_sat_r507a, 'r508b':df_sat_r508b, 'r513a':df_sat_r513a, 'r600a':df_sat_r600a, 'r717':df_sat_r717, 'r744':df_sat_r744, 'r1233zd':df_sat_r1233zd, 'r1234yf':df_sat_r1234yf}
...
sup_refrigerantDict = {'r23':df_sup_r23, 'r32':df_sup_r32, 'r134a':df_sup_r134a, 'r236fa':df_sup_r236fa, 'r245fa':df_sup_r245fa, 'r290':df_sup_r290, 'r404a':df_sup_r404a, 'r407a':df_sup_r407a, 'r410a':df_sup_r410a, 'r438a':df_sup_r438a, 'r449a':df_sup_r449a, 'r452a':df_sup_r452a, 'r455a':df_sup_r455a, 'r507a':df_sup_r507a, 'r508b':df_sup_r508b, 'r513a':df_sup_r513a, 'r600a':df_sup_r600a, 'r717':df_sup_r717, 'r744':df_sup_r744, 'r1233zd':df_sup_r1233zd, 'r1234yf':df_sup_r1234yf}
